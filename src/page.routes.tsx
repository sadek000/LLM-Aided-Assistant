/** 
  All of the routes for the ALDR Tech Dashboard React are added here,
...
const pageRoutes = [
  ...
  },
  {
    ...
    collapse: [
      ...
      {
        name: "foundation",
        href: " learning-lab/react/colors/material-dashboard/",
        description: "See our colors, icons and typography",
        icon: <Icon>grading</Icon>,
      },
      {
        name: "components",
        href: " learning-lab/react/alerts/material-dashboard/",
        description: "Explore our collection of fully designed components",
        icon: <Icon>apps</Icon>,
      },
      {
        name: "plugins",
        href: " learning-lab/react/datepicker/material-dashboard/",

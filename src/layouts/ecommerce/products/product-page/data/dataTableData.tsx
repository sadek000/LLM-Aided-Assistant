  ...
  rows: [
    {
      ...
      availability: (
        <ATBox width="8rem">
          <ATProgress variant="gradient" value={80} color="success" />
        </ATBox>
      ),
    ...
    },
    {
      ...
      availability: (
        <ATBox width="8rem">
          <ATProgress variant="gradient" value={90} color="success" />
        </ATBox>
      ),
    ...
    },
    {
      ...
      availability: (
        <ATBox width="8rem">
          <ATProgress variant="gradient" value={60} color="warning" />
        </ATBox>
      ),
    ...
    },
    {
      ...
      availability: (
        <ATBox width="8rem">
          <ATProgress variant="gradient" value={40} color="warning" />
        </ATBox>
      ),

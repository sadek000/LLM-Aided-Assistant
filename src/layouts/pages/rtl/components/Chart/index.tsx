  ...
  return (
    <Card>
      <ATBox p={2} lineHeight={1}>
        <ATTypography variant="button" textTransform="capitalize" fontWeight="medium" color="text">
          {title}
        </ATTypography>
        <ATTypography variant="h5" fontWeight="bold" color="dark">
          {count}&nbsp;
      ...
      {useMemo(
        () => (
          <ATBox ref={chartRef} sx={{ height: "5.375rem" }}>
